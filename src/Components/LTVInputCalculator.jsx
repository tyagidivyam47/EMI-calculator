...
const LTVInputCalculator = ({ sendData }) => {
    ...
    return (
        <Box display={'flex'}>
            <Box display={"flex"} flexDirection={"column"} gap={"10px"} borderRight={'2px solid #d3d3d3'} paddingRight={'15px'}>
                <Box>
                    <div
                        style={{
                            fontWeight: "600",
            ...
            <Box display={"flex"} flexDirection={"column"} gap={"10px"} paddingLeft={'15px'}>
                <Box marginBottom={'14px'}>
                    ...
                    >
                        ...
                        <FormControlLabel value="selfEmployed" control={<Radio />} label="Self-Employed" />
                    </RadioGroup>
                </Box>
                ...
                <Box marginBottom={'14px'}>
                    ...
                    <RadioGroup
                        ...
                        value={propType}
                    >
                        <FormControlLabel value="residential" control={<Radio />} label="Residential Property" />
                        <FormControlLabel value="commercial" control={<Radio />} label="Commercial Property" />
                    </RadioGroup>
                </Box>
